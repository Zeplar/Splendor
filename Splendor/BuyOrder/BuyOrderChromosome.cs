...
namespace Splendor.BuyOrder
{
	...
	public class BuyOrderChromosome : PermutationChromosome
	{
        ...
        /// 
        protected BuyOrderChromosome( BuyOrderChromosome source ) : base( source )
        {
		...
		{
			return new BuyOrderChromosome( length );
		}
		...
		{
			return new BuyOrderChromosome( this );
		}
        ...
        /// chosen genes (array elements). One gene must be in evaluation range.</para></remarks>
        ///
